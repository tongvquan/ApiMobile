...
public class NoteApi {
	...
	@GetMapping("/note/search/{userId}")
	public List<NoteDto> searchNote(@RequestParam String title, @PathVariable Long userId) {
		return userService.searchNote(title,userId);
	}
